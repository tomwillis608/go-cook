...
<span><strong>Cook:</strong> 5 hours</span>
<span><strong>Yields:</strong> 4 to6 servings.</span>
</div>

This was a common cold weather dinner I learned as a tween.
My first dump-and-bake.

## Ingredients

- [x] 2 pounds beef stew meat, cubed
- [x] 1 cup sliced carrots
- [x] 2 onions, chopped
- [x] 1 teaspoon salt
- [x] dash of pepper
- [x] 1 can cream of tomato soup
- [x] &frac12; soup can of water
- [x] 1 big potato, sliced
- [x] piece of bay leaf
